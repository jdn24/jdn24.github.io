...
class SocialShare{
    ...
    static function get_social_share($_post, $socialLabelsDef, $queryString) {
        ...
        // twitter
        $res .= '<span tabindex="0" role="button" aria-label="Share on XTwitter" title="Share on XTwitter" data-href="https://twitter.com/share?url='.urlencode($link).'&text='.urlencode(html_entity_decode($title, ENT_COMPAT, 'UTF-8')).'" class="tw gs-share-link" data-service="twitter"><span class="social-share-icon"  aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 462.799"><path fill-rule="nonzero" fill="currentColor" d="M403.229 0h78.506L310.219 196.04 512 462.799H354.002L230.261 301.007 88.669 462.799h-78.56l183.455-209.683L0 0h161.999l111.856 147.88L403.229 0zm-27.556 415.805h43.505L138.363 44.527h-46.68l283.99 371.278z"/></svg></span><span class="social-share-label"><span>' . $socialLabelsDef['tw'] .'</span><span class="dark-bg"></span></span></span>';
