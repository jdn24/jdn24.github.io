...
/**
 * Title: Features list block Light
 * Slug: greenshift/general-features-list-light
 * Categories: greenshift-general
 */
?>

<!-- wp:columns {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"0","right":"0"}}}} -->
<div class="wp-block-columns alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-right:0;padding-bottom:var(--wp--preset--spacing--80);padding-left:0"><!-- wp:column {"width":"50%"} -->
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:group {"align":"full","style":{"border":{"radius":"0px"},"spacing":{"blockGap":"12px","margin":{"top":"0px","bottom":"var:preset|spacing|80"}}},"className":"full-width","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group alignfull full-width" style="border-radius:0px;margin-top:0px;margin-bottom:var(--wp--preset--spacing--80)">

<!-- wp:group {"align":"full","style":{"border":{"radius":"100px","width":"1px","color":"#cecece6b"},"spacing":{"blockGap":"8px","padding":{"top":"4px","right":"12px","bottom":"4px","left":"12px"}},"elements":{"link":{"color":{"text":"var:preset|color|basecolor"}}}},"backgroundColor":"contrastcolor","textColor":"basecolor","className":"","layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<!-- wp:heading {"textAlign":"left","style":{"typography":{"fontWeight":"500","lineHeight":"1.2"}},"className":"wp-block-heading has-roboto-font-family","fontSize":"max-gigantic"} -->
...
<!-- wp:group {"align":"full","style":{"border":{"radius":"0px"},"spacing":{"blockGap":"32px"}},"className":"full-width","layout":{"type":"flex","orientation":"horizontal","justifyContent":"left","verticalAlignment":"top","flexWrap":"nowrap"}} -->
<div class="wp-block-group alignfull full-width" style="border-radius:0px"><!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"40px"}},"className":"full-width","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group alignfull full-width"><!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"12px"}},"className":"full-width","layout":{"type":"flex","orientation":"horizontal","justifyContent":"left","verticalAlignment":"top","flexWrap":"nowrap"}} -->
<div class="wp-block-group alignfull full-width"><!-- wp:image {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"4px"}},"className":"full-width","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group alignfull full-width"><!-- wp:paragraph {"align":"left","style":{"typography":{"lineHeight":"1.3","fontStyle":"normal","fontWeight":"500"}},"className":"full-width text-nowrap","fontSize":"medium"} -->
...
<!-- wp:paragraph {"align":"left","style":{"typography":{"lineHeight":"1.7"}},"className":"full-width","fontSize":"xsmall"} -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"12px"}},"className":"full-width","layout":{"type":"flex","orientation":"horizontal","justifyContent":"left","verticalAlignment":"top","flexWrap":"nowrap"}} -->
<div class="wp-block-group alignfull full-width"><!-- wp:image {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
...
<!-- wp:group {"align":"full","style":{"border":{"radius":"0px"},"spacing":{"blockGap":"4px"}},"className":"full-width","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group alignfull full-width" style="border-radius:0px"><!-- wp:paragraph {"align":"left","style":{"typography":{"fontWeight":"500","lineHeight":"1.3","fontStyle":"normal"}},"className":"full-width text-nowrap","fontSize":"medium"} -->
...
<!-- wp:paragraph {"align":"left","style":{"typography":{"fontWeight":"400","lineHeight":"1.7"}},"className":"full-width","fontSize":"xsmall","fontFamily":"Inter"} -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"40px"}},"className":"full-width","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group alignfull full-width"><!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"12px"}},"className":"full-width","layout":{"type":"flex","orientation":"horizontal","justifyContent":"left","verticalAlignment":"top","flexWrap":"nowrap"}} -->
<div class="wp-block-group alignfull full-width"><!-- wp:image {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"4px"}},"className":"full-width","layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"top"}} -->
<div class="wp-block-group alignfull full-width"><!-- wp:paragraph {"align":"left","style":{"typography":{"fontWeight":"500","lineHeight":"1.3","fontStyle":"normal"}},"className":"full-width text-nowrap","fontSize":"medium"} -->
...
<!-- wp:paragraph {"align":"left","style":{"typography":{"fontWeight":"400","lineHeight":"1.7"},"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"className":"full-width","fontSize":"xsmall","fontFamily":"Inter"} -->
...
<!-- wp:column {"width":"40%"} -->
<div class="wp-block-column" style="flex-basis:40%"><!-- wp:image {"align":"right","id":4015,"sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":"12px"}}} -->
<figure class="wp-block-image alignright size-large has-custom-border"><img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/img/v2/placeholder.svg'; ?>" alt="" class="wp-image-4015" style="border-radius:12px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->