...
/**
 * Title: Banner block 2 light
 * Slug: greenshift/general-banner2-light
 * Categories: greenshift-general
 */
?>
<!-- wp:columns {"align":"wide","style":{"spacing":{"padding":{"top":"6vw","bottom":"6vw","left":"6vw","right":"6vw"},"margin":{"bottom":"var:preset|spacing|80"}},"border":{"radius":"16px"},"color":{"background":"#f5f8fb","text":"#000000"},"elements":{"link":{"color":{"text":"#000000"}}}}} -->
<div class="wp-block-columns alignwide has-text-color has-background has-link-color" style="border-radius:16px;color:#000000;background-color:#f5f8fb;margin-bottom:var(--wp--preset--spacing--80);padding-top:6vw;padding-right:6vw;padding-bottom:6vw;padding-left:6vw"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1.3"}},"fontSize":"x-large"} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"xsmall"} -->
...
<!-- wp:column {"width":"45%"} -->
<div class="wp-block-column" style="flex-basis:45%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:group {"align":"full","style":{"typography":{"lineHeight":"1"},"color":{"background":"rgba(255,255,255,1)"},"border":{"radius":"12px","width":"1px","color":"#cecece6b"},"spacing":{"blockGap":"8px","padding":{"top":"10px","right":"18px","bottom":"10px","left":"18px"}}},"className":"","layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group alignfull has-border-color has-background" style="border-color:#cecece6b;border-width:1px;border-radius:12px;background-color:rgba(255,255,255,1);padding-top:10px;padding-right:18px;padding-bottom:10px;padding-left:18px;line-height:1"><!-- wp:image {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
...
<!-- wp:group {"align":"full","style":{"typography":{"lineHeight":"1"},"color":{"background":"rgba(255,255,255,1)"},"border":{"radius":"12px","width":"1px","color":"#cecece6b"},"spacing":{"blockGap":"8px","padding":{"top":"10px","right":"18px","bottom":"10px","left":"18px"}}},"className":"","layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group alignfull has-border-color has-background" style="border-color:#cecece6b;border-width:1px;border-radius:12px;background-color:rgba(255,255,255,1);padding-top:10px;padding-right:18px;padding-bottom:10px;padding-left:18px;line-height:1"><!-- wp:image {"style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
<figure class="wp-block-image" style="margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px"><img src="data:image/svg+xml,%3Csvg width=&quot;18&quot; height=&quot;18&quot; viewBox=&quot;0 0 18 18&quot; fill=&quot;none&quot; xmlns=&quot;http://www.w3.org/2000/svg&quot;%3E%3Cpath fill-rule=&quot;evenodd&quot; clip-rule=&quot;evenodd&quot; d=&quot;M9.00033 0.666626C4.39795 0.666626 0.666992 4.39759 0.666992 8.99996C0.666992 13.6023 4.39795 17.3333 9.00033 17.3333C13.6027 17.3333 17.3337 13.6023 17.3337 8.99996C17.3337 4.39759 13.6027 0.666626 9.00033 0.666626ZM12.1453 7.44435C12.4367 7.08814 12.3842 6.56313 12.028 6.27169C11.6718 5.98025 11.1468 6.03275 10.8554 6.38895L7.68846 10.2596L6.67291 9.24406C6.34748 8.91862 5.81984 8.91862 5.4944 9.24406C5.16897 9.5695 5.16897 10.0971 5.4944 10.4226L7.16107 12.0892C7.32755 12.2557 7.55669 12.344 7.79184 12.3323C8.02699 12.3206 8.2462 12.2099 8.39529 12.0277L12.1453 7.44435Z&quot; fill=&quot;%23FF4B0E&quot;/%3E%3C/svg%3E%0A" alt=""/></figure>
<!-- /wp:image -->
