 ...
 */
?>
<!-- wp:group {"tagName":"main","align":"full","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|70","top":"var:preset|spacing|30","right":"var:preset|spacing|50","left":"var:preset|spacing|50"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained","wideSize":"1000px"}} -->
...
<!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|textonbutton"}}},"spacing":{"padding":{"top":"var:preset|spacing|80","right":"var:preset|spacing|70","bottom":"var:preset|spacing|80","left":"var:preset|spacing|70"},"margin":{"bottom":"var:preset|spacing|70"}},"border":{"radius":"15px"}},"backgroundColor":"lightbg","textColor":"textonbutton","layout":{"type":"default"}} -->
<div class="wp-block-group has-textonbutton-color has-lightbg-background-color has-text-color has-background has-link-color" style="border-radius:15px;margin-bottom:var(--wp--preset--spacing--70);padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--70)"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"width":"70%"} -->
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}}} -->
<div class="wp-block-group"><!-- wp:post-terms {"term":"category","separator":"  ","style":{"typography":{"textTransform":"uppercase"}},"className":"is-style-gs-tags-rounded","fontSize":"xsmall"} /-->

<!-- wp:post-title {"level":1,"isLink":true,"style":{"typography":{"lineHeight":"1.4"}},"fontSize":"x-large"} /-->
...
<!-- wp:query {"queryId":22,"query":{"perPage":"6","pages":0,"offset":"1","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"align":"wide","className":"is-style-default"} -->
...
<!-- wp:post-terms {"term":"category","separator":"  ","style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"className":"is-style-greenshift-tags-nounder","fontSize":"xsmall"} /-->
