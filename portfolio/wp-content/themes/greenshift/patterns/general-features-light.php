...
/**
 * Title: Features block Homepage Light
 * Slug: greenshift/general-features-main-light
 * Categories: greenshift-general
 */
?>
<!-- wp:columns {"verticalAlignment":"bottom","align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":{"top":"var:preset|spacing|60","left":"var:preset|spacing|70"}}}} -->
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1.2"}},"fontSize":"max-gigantic"} -->
...
<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:40%"><!-- wp:paragraph {"fontSize":"small"} -->
...
<div class="wp-block-columns alignwide" style="margin-bottom:var(--wp--preset--spacing--50)"><!-- wp:column {"style":{"border":{"width":"1px"},"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60","right":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|40"}},"borderColor":"lightborder","className":"is-style-softborder"} -->
<div class="wp-block-column is-style-softborder has-border-color has-lightborder-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:image {"width":"30px","height":"30px","scale":"cover"} -->
...
<!-- wp:paragraph {"align":"left","style":{"typography":{"lineHeight":"1.3"}},"className":"full-width text-nowrap","fontSize":"subheading"} -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"spacing":{"padding":{"left":"var:preset|spacing|30","right":"var:preset|spacing|30","top":"0.2rem","bottom":"0.2rem"}}},"className":"is-style-systemdark","fontSize":"xsmall"} -->
...
<!-- wp:column {"style":{"border":{"width":"1px"},"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60","right":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|40"}},"borderColor":"lightborder","className":"is-style-softborder"} -->
<div class="wp-block-column is-style-softborder has-border-color has-lightborder-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:image {"width":"30px"} -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"textAlign":"left","style":{"spacing":{"padding":{"left":"var:preset|spacing|30","right":"var:preset|spacing|30","top":"0.2rem","bottom":"0.2rem"}}},"className":"is-style-systemdark","fontSize":"xsmall"} -->
...
<div class="wp-block-columns alignwide" style="margin-bottom:var(--wp--preset--spacing--80)"><!-- wp:column {"style":{"border":{"width":"1px"},"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60","right":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|40"}},"borderColor":"lightborder","className":"is-style-softborder"} -->
<div class="wp-block-column is-style-softborder has-border-color has-lightborder-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)"><!-- wp:image {"width":"30px","height":"30px","scale":"cover"} -->
